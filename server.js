...
app.post('/process_post', urlencodedParser, function (req, res) {
   ...
   async function firstFunction(){
       // convert pastor's slides (pdf) into several png images
       //const pythonProcess = spawn('bash', ["scripts/pdf2jpg.sh", response.preach_slides.path, __dirname + '/' + 'slides/preach/'])
